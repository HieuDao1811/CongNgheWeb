...
<div class="login-card">
  ...
  <form action="login" method="post">
    ...
    <!-- Username -->
    <div class="mb-3">
      <label class="form-label" for="usernameId">Tên đăng nhập</label>
      <input type="text" name="username" id="usernameId" class="form-control" required>
    </div>

    <!-- Password -->
    <div class="mb-3">
      <label class="form-label" for="passwordId">Mật khẩu</label>
      <input type="password" name="password" id="passwordId" class="form-control" required>
    </div>
    ...
    <div class="text-center mt-3">
      Chưa có tài khoản?
      <a href="register.jsp" style="color:#9E896D;">Đăng ký ngay</a>
    </div>
